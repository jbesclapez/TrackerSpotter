...
#### Linux
1. **Download** `TrackerSpotter_Linux.tar.gz` from the [releases page](https://github.com/jbesclapez/TrackerSpotter/releases)
...
# Output: dist/TrackerSpotter.app and dist/TrackerSpotter_v1.1.0_macOS.dmg
```

#### Linux
```bash
python build_scripts/build_linux.py
# Output: dist/trackerspotter and dist/TrackerSpotter_v1.1.0_Linux.tar.gz
```
...
TrackerSpotter v1.1.0 is a complete, production-ready monitoring solution with:
